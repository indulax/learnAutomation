...
public class TextBoxOperations {
	...
	public static void main(String[] args) {
		...
		emailBox.sendKeys("test@asd.com");

		WebElement appendBox = driver
				.findElement(By.xpath("//*[@id=\"contentblock\"]/section/div[2]/div/div/input"));
		appendBox.sendKeys("appended");

		WebElement defaultTextBox = driver.findElement(By.name("username"));
		String value = defaultTextBox.getAttribute("value");
